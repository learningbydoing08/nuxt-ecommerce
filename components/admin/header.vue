        ...
        <div class="dropdown-menu dropdown-menu-right pt-0">
          ...
          <a class="dropdown-item" href="#">
            <svg class="c-icon mr-2">
              <use
                xlink:href="~@coreui/icons/sprites/free.svg#cil-folder"
              ></use>
            </svg>
            Categories</a
          ><a class="dropdown-item" href="#">
            <svg class="c-icon mr-2">
              <use
                xlink:href="~@coreui/icons/sprites/free.svg#cil-layers"
              ></use>
            </svg>
            Products</a
          ><a class="dropdown-item" href="#">
          ...
          <a class="dropdown-item" href="#">
            <svg class="c-icon mr-2">
              <use xlink:href="~@coreui/icons/sprites/free.svg#cil-cart"></use>
            </svg>
            Invoices</a
          >
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" role="button" @click="logout">
            <svg class="c-icon mr-2">
              <use
                xlink:href="~@coreui/icons/sprites/free.svg#cil-account-logout"
              ></use>
            </svg>
            Logout
          </a>
